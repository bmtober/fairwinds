...
Notice from the standings that Bob has a fc374 demand note written against him
as well as a negative fc70 net cash balance:
...
but the details of his wealth are altered buy borrowing Faircoin:
...
That is, his net wealth remains unchanged at negative fc444, but he temporarily
has cash on hand and so can place an order to buy the demand note upon which he
...
which results in Bob becoming listed as factor as well as the debtor on bond
`91032ad7bbcb6c`:
...
Bob then waits for time to advance beyond the bond maturity. When the bond is
redeemed, his fc70 cash short-fall results in a new bond, bond
`fc074d501302eb`, scheduled for issuance ten clicks from the present at click
413:
...
None-the-less, it is apparent from the standings that his position is improved
because his net wealth has increased from -fc440 to -fc70 because his taking
ownership of note `91032ad7bbcb6c` offsets the debt. That is, he has the rights
call to his own debt, making for a wash.
...
Bob can bid to by that new note, too:

--------------------------------------------
fairwinds=> insert into note_bid (serial_number, price) values ('fc074d501302eb', 0);
INSERT 0 1
--------------------------------------------

And then ten clicks later his bid executes when the bond is actually issued:
...
Lastly, while Bob has zero cash balance, he can call the notes he owns to
...
only works this well if other 'Fairians' are not paying attention. In a
competitive market, others would be watching for profitable opportunities and
likely make bids competing with those shown above for illustration, thus
