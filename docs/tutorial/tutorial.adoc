...
Alice proceeds to place a buy order for the note. 
...
redeemed, his fc70 cash short-fall results in a new bond ('i.e.', bond
`fc074d501302eb`) scheduled for issuance ten clicks from the present, 'i.e.',
 at click 413:
...
because his net wealth has increased to -fc70 from -fc444 because his taking
ownership of note `91032ad7bbcb6c` offsets the debt. That is, he has the rights
call to his own debt, making for a wash with respect to the fc374 note.
...
Bob can bid to buy the new fc70 note, too:
